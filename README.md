...
Use code to create 3D Models with features ranging from simple primitives + CSG to complex revolves, sweeps, and fillets.  AICAD exposes the full power of the [OpenCascade](https://github.com/Open-Cascade-SAS/OCCT) kernel, while providing a concise standard library for simple operations.
...
<p align="center">
  ...
  <img title="Install AICAD for working offline!"                          src="./icon/Installable.gif"  width="275">
...
AICAD is built with vanilla JavaScript and static assets. To run it locally, follow these steps:
...
This will start a local server, and you can access AICAD in your web browser at the URL provided by the `serve` command (usually `http://localhost:8000`).
...
AICAD is maintained by [Johnathon Selstad @zalo](https://github.com/zalo) and created by Arya.
